        ...
        <div class="bg-white shadow rounded-lg overflow-hidden">
            <table class="w-full text-left">
                ...
                <tbody class="text-gray-700">
                        ...
                        <tr class="border-b border-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex space-x-2">
                                    ...
                                    <form method="POST" action="{{ route('delete.category', $category->id) }}" class="inline">
                                        @csrf
                                        <button type="submit"
                                            class="bg-orange-500 text-white px-4 py-1 rounded hover:bg-orange-600 transition duration-200">
                                            Delete
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="p-4 text-center text-black font-semibold">No category found</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
