        ...
        <div class="py-5">
            <div class="container mx-auto">
                <div class="flex flex-wrap -mx-2">
                    ...
                    <!-- Accessories -->
                    <a href="{{url('#')}}" class="w-full md:w-1/3 px-2 mb-4">
                        <div class="relative rounded overflow-hidden">
                            <img src="{{asset('images/accessories.jpg')}}"
                                class="w-full h-[200px] object-cover rounded lazy" alt="">
                    ...
                    <a href="{{url('#')}}" class="w-full md:w-1/3 px-2 mb-4">
                        <div class="relative rounded overflow-hidden">
                            <img src="{{asset('images/equipments.jpg')}}"
                                class="w-full h-[200px] object-cover rounded lazy" alt="">
                            <div class="absolute inset-0 flex items-center justify-center text-white">
                    ...
                    <a href="{{url('#')}}" class="w-full md:w-1/3 px-2 mb-4">
                        <div class="relative rounded overflow-hidden">
                            <img src="{{asset('images/supplements.jpg')}}"
                                class="w-full h-[200px] object-cover rounded lazy" alt="">
                            <div class="absolute inset-0 flex items-center justify-center text-white">
